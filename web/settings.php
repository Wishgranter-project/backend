...
define('DIR_APP',                        IS_TEST_ENVIRONMENT ? DIR_PUBLIC : DIR_PUBLIC . 'player-backend/web/');
...
$settings['corsAllowedDomain'] = IS_TEST_ENVIRONMENT
    ? '*' // Local
    : 'adinancenci.com.br';  // Production
